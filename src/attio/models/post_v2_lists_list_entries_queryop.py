...
PostV2ListsListEntriesQueryEntryValueUnion = Annotated[
    Union[
        Annotated[
            PostV2ListsListEntriesQueryEntryValueActorReference, Tag("actor-reference")
        ],
        Annotated[PostV2ListsListEntriesQueryEntryValueCheckbox, Tag("checkbox")],
        Annotated[PostV2ListsListEntriesQueryEntryValueCurrency, Tag("currency")],
        Annotated[PostV2ListsListEntriesQueryEntryValueDate, Tag("date")],
        Annotated[PostV2ListsListEntriesQueryEntryValueDomain, Tag("domain")],
        Annotated[
            PostV2ListsListEntriesQueryEntryValueEmailAddress, Tag("email-address")
        ],
        Annotated[
            PostV2ListsListEntriesQueryEntryValueRecordReference,
            Tag("record-reference"),
        ],
        Annotated[PostV2ListsListEntriesQueryEntryValueInteraction, Tag("interaction")],
        Annotated[PostV2ListsListEntriesQueryEntryValueLocation, Tag("location")],
        Annotated[PostV2ListsListEntriesQueryEntryValueNumber, Tag("number")],
        Annotated[
            PostV2ListsListEntriesQueryEntryValuePersonalName, Tag("personal-name")
        ],
        Annotated[
            PostV2ListsListEntriesQueryEntryValuePhoneNumber, Tag("phone-number")
        ],
        Annotated[PostV2ListsListEntriesQueryEntryValueStatus, Tag("status")],
        Annotated[PostV2ListsListEntriesQueryEntryValueRating, Tag("rating")],
        Annotated[PostV2ListsListEntriesQueryEntryValueSelect, Tag("select")],
        Annotated[PostV2ListsListEntriesQueryEntryValueText, Tag("text")],
        Annotated[PostV2ListsListEntriesQueryEntryValueTimestamp, Tag("timestamp")],
    ],
...
try:
    PostV2ListsListEntriesQueryRequestBody.model_rebuild()
except NameError:
    pass
