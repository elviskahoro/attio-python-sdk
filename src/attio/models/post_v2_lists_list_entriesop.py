...
PostV2ListsListEntriesEntryValueUnion = Annotated[
    Union[
        Annotated[
            PostV2ListsListEntriesEntryValueActorReference, Tag("actor-reference")
        ],
        Annotated[PostV2ListsListEntriesEntryValueCheckbox, Tag("checkbox")],
        Annotated[PostV2ListsListEntriesEntryValueCurrency, Tag("currency")],
        Annotated[PostV2ListsListEntriesEntryValueDate, Tag("date")],
        Annotated[PostV2ListsListEntriesEntryValueDomain, Tag("domain")],
        Annotated[PostV2ListsListEntriesEntryValueEmailAddress, Tag("email-address")],
        Annotated[
            PostV2ListsListEntriesEntryValueRecordReference, Tag("record-reference")
        ],
        Annotated[PostV2ListsListEntriesEntryValueInteraction, Tag("interaction")],
        Annotated[PostV2ListsListEntriesEntryValueLocation, Tag("location")],
        Annotated[PostV2ListsListEntriesEntryValueNumber, Tag("number")],
        Annotated[PostV2ListsListEntriesEntryValuePersonalName, Tag("personal-name")],
        Annotated[PostV2ListsListEntriesEntryValuePhoneNumber, Tag("phone-number")],
        Annotated[PostV2ListsListEntriesEntryValueStatus, Tag("status")],
        Annotated[PostV2ListsListEntriesEntryValueRating, Tag("rating")],
        Annotated[PostV2ListsListEntriesEntryValueSelect, Tag("select")],
        Annotated[PostV2ListsListEntriesEntryValueText, Tag("text")],
        Annotated[PostV2ListsListEntriesEntryValueTimestamp, Tag("timestamp")],
    ],
