...
PutV2ObjectsObjectRecordsForbiddenType = Literal["auth_error",]


PutV2ObjectsObjectRecordsCodeUnauthorized = Literal["unauthorized",]
...
PutV2ObjectsObjectRecordsValueUnion = Annotated[
    Union[
        Annotated[PutV2ObjectsObjectRecordsValueActorReference, Tag("actor-reference")],
        Annotated[PutV2ObjectsObjectRecordsValueCheckbox, Tag("checkbox")],
        Annotated[PutV2ObjectsObjectRecordsValueCurrency, Tag("currency")],
        Annotated[PutV2ObjectsObjectRecordsValueDate, Tag("date")],
        Annotated[PutV2ObjectsObjectRecordsValueDomain, Tag("domain")],
        Annotated[PutV2ObjectsObjectRecordsValueEmailAddress, Tag("email-address")],
        Annotated[
            PutV2ObjectsObjectRecordsValueRecordReference, Tag("record-reference")
        ],
        Annotated[PutV2ObjectsObjectRecordsValueInteraction, Tag("interaction")],
        Annotated[PutV2ObjectsObjectRecordsValueLocation, Tag("location")],
        Annotated[PutV2ObjectsObjectRecordsValueNumber, Tag("number")],
        Annotated[PutV2ObjectsObjectRecordsValuePersonalName, Tag("personal-name")],
        Annotated[PutV2ObjectsObjectRecordsValuePhoneNumber, Tag("phone-number")],
        Annotated[PutV2ObjectsObjectRecordsValueStatus, Tag("status")],
        Annotated[PutV2ObjectsObjectRecordsValueRating, Tag("rating")],
        Annotated[PutV2ObjectsObjectRecordsValueSelect, Tag("select")],
        Annotated[PutV2ObjectsObjectRecordsValueText, Tag("text")],
        Annotated[PutV2ObjectsObjectRecordsValueTimestamp, Tag("timestamp")],
    ],
